  ...
  return (
    <div className="block rounded-lg p-4 shadow-sm shadow-indigo-300">
      ...
      <div>
        ...
        <h2 className="flex flex-row gap-2"> <Image src={'/best-price.png'} width={22} height={22} alt="meun"/>: {product?.attributes?.price} <Image src={'/menu.png'} width={22} height={22} alt="meun"/></h2>
