...
const getProductById_ = ()=>{
  ...
  return (
    <div className='py-8'>
      <BreadCrumb/>
      <div className="px-2 py-5 grid grid-clos-1 sm:grid-cols-2  mx-9 gap-9 ">
        <ProductDetailsBanner productDetails={productDetails} className="mx-3"/>
        <ProductInfoDetails productDetails={productDetails}  className="mx-3"/>
      </div>
